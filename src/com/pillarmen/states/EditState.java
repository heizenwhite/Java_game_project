...
import com.pillarmen.entity.enemy.Beastman;
...
import com.pillarmen.ui.Button;
...
public class EditState extends GameState {
    ...
    public EditState(GameStateManager gsm, Camera cam) {
        ...
        btnEnemy1.addEvent(e -> {
            selection = 1;
            entityList[1] = new Beastman(cam, new SpriteSheet(enemySheet.getSprite(0, 0, 128, 32), "tiny monster", 16, 16),
        ...
        btnEnemy2.addEvent(e -> {
            selection = 2;
            entityList[2] = new Beastman(cam, new SpriteSheet(enemySheet.getSprite(0, 1, 128, 32), "tiny boar", 16, 16),
							new Vector2f((GamePanel.width / 2) - 32 + 150, 0 + (GamePanel.height / 2) - 32 + 150), 48);
        });
    }
